...
public class UserAccountPageUI {
    public final static String CURRENT_MESSAGE_UNDER_PAGE_TITLE = "css=ul.messages>li.success-msg span";
    public final static String DYNAMIC_LINK_AT_LEFT_SIDEBAR = "xpath=//div[contains(@class, 'sidebar')]//div[@class='block-content']//li//a[text()='%s']";
